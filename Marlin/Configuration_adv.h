...
#define HOMING_BUMP_MM      { 5, 5, 5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump //  { 5, 5, 2 } 
#define HOMING_BUMP_DIVISOR { 10, 10, 10}       // Re-Bump Speed Divisor (Divides the Homing Feedrate) // { 2, 2, 4 }
