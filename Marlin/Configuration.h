...
#define STRING_CONFIG_H_AUTHOR "(KOlasmics, Marlinino)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//#define SERIAL_PORT_3 2 // octopus: #define SERIAL_PORT_3 2
...
//#define Z2_DRIVER_TYPE TMC2209 // enabled in octopus
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki  36.95
    #define DEFAULT_Kd  0.98
  #endif
#endif
...
#define XY_PROBE_FEEDRATE 2000 // (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (30*60) // (4*60)
...
#define Z_MIN_POS 0
#define X_MAX_POS 132 //X_BED_SIZE
#define Y_MAX_POS 132 //Y_BED_SIZE
...
#define HOMING_FEEDRATE_MM_M { (45*60), (45*60), (45*60) } // { (50*60), (50*60), (4*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, (-122), 20 } // (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 }
